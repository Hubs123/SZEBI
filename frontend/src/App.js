      ...
      <Routes>
        ...
        >
          ...
          <Route path="sterowanie" element={<ControlLayout />}>
            ...
            />
            <Route
              path="urzadzenia/:deviceId/parametry"
              element={
                <RoleProtectedRoute guard={requireResident}>
                  <DeviceParamsPage />
                </RoleProtectedRoute>
            ...
            />
            <Route
              path="urzadzenia/:deviceId/przypisz"
              element={
                <RoleProtectedRoute guard={requireResident}>
            ...
            />
            <Route
              path="plany/:planId/reguly/dodaj"
              element={
                <RoleProtectedRoute guard={requireResident}>
                  <PlanAddRulePage />
                </RoleProtectedRoute>
          ...
          <Route
            path="symulacja"
            element={<Placeholder title="Moduł Symulacji" />}
          />
